...
if (page === 'subpageA') {
    __webpack_require__.e(/* import() | subpageA */ 2).then(__webpack_require__.bind(null, 4))
        .then(function(subPageA) {
            console.log(subPageA)
        })
} else if (page === 'subPageB') {
    __webpack_require__.e(/* import() | subpageB */ 3).then(__webpack_require__.bind(null, 5))
