...
(function ($) {
    ...
    $.fn.wPaint.defaultSettings = {
        ...
        menuOffsetY: 308,					// offset for menu (top)
    ...
    Canvas.prototype =
    {
        ...
        generateBg: function (width, height, data) {
            ...
            if (!this.canvasBg) {
                ...
                $(this.canvasBg).attr('id', 'mofo').css({ position: 'absolute', left: 0, top: 0, borderRadius: '4px' }).attr('width', width).attr('height', height);
            }
        ...
        generateTextInput: function () {
            ...
            _self.textInput =
                $('<textarea class="_wPaint_textInput" spellcheck="false"></textarea>')
                    .css({ display: 'none', position: 'absolute', color: '#FF0000', fontSize: this.settings.fontSize, lineHeight: this.settings.fontSize + 'px', fontFamily: this.settings.fontFamily })
    ...
    MainMenu.prototype =
    {
        generate: function (canvas, textMenu) {
            ...
            $.each($canvas.settings.menu, function (i, item) {
                switch (item) {
                    case 'undo': menuContent.append($('<div class="_wPaint_icon _wPaint_undo"></div>').click(function () { $canvas.undoPrev(); })); break;
                    case 'redo': menuContent.append($('<div class="_wPaint_icon _wPaint_redo"></div>').click(function () { $canvas.undoNext(); })); break;
                    case 'clear': menuContent.append($('<div class="_wPaint_icon _wPaint_clear"></div>').click(function () { $canvas.clearAll(); })); break;
                    case 'rectangle': menuContent.append($('<div class="_wPaint_icon _wPaint_rectangle"></div>').click(function () { _self.set_mode(_self, $canvas, 'Rectangle'); })); break;
                    case 'ellipse': menuContent.append($('<div class="_wPaint_icon _wPaint_ellipse"></div>').click(function () { _self.set_mode(_self, $canvas, 'Ellipse'); })); break;
                    // case 'line': menuContent.append($('<div class="_wPaint_icon _wPaint_line"></div>').click(function () { _self.set_mode(_self, $canvas, 'Line'); })); break;
                    case 'pencil': menuContent.append($('<div class="_wPaint_icon _wPaint_pencil"></div>').click(function () { _self.set_mode(_self, $canvas, 'Pencil'); })); break;
                    case 'text': menuContent.append($('<div class="_wPaint_icon _wPaint_text"></div>').click(function () { _self.set_mode(_self, $canvas, 'Text'); })); break;
                    // case 'eraser': menuContent.append($('<div class="_wPaint_icon _wPaint_eraser"></div>').click(function (e) { _self.set_mode(_self, $canvas, 'Eraser'); })); break;
                    // case 'fillColor': menuContent.append($('<div class="_wPaint_fillColorPicker _wPaint_colorPicker"></div>')); break;
